    ...
    <div className="bg-zinc-100 p-5 rounded-xl">
      ...
      <div className="flex justify-between">
        <button 
          ...
          className={`text-3xl transition-colors ${isFavorite(name) ? "text-red-500" : "text-zinc-300 hover:text-red-500"}`}
        >
          <FaHeart />
        </button>

        <button className="bg-gradient-to-b from-red-500 to-orange-500 text-white text-xl px-4 py-3 rounded-lg">
          <FaPlus />
        </button>
      </div>
